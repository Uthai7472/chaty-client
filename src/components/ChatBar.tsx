  ...
  const handleClick = async () => {
    ...
    try {
      ...
      if (formData.message) {
        ...
        const response = await axios.post(`https://chaty-server1.vercel.app/api/chat/send`, updatedFormData);
      ...
      if (selectedFile) {
        ...
        await axios.post(`https://chaty-server1.vercel.app/api/upload/image`, imageFormData)
        .then(response => {
          console.log(response.data);
        })
        .catch(error => {
        ...
        await axios.post(`https://chaty-server1.vercel.app/api/chat/send`, updatedImageFormData)
        .then(response => {
          console.log(response.data);
        })
        .catch(error => {
